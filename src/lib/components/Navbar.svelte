...
<nav
  class="z-50 fixed top-0 w-full border-b-4 border-emerald-700 bg-gradient-to-r from-emerald-600 to-[#008080]">
  <div
    ...
    <div
      ...
      <a
        href="/"
        class="px-6 py-2 text-lg text-white font-medium
